...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'Repository.ascendent'
        db.rename_column('hgwebproxy_repository', 'ascendent_id', 'parent_repo_id')

    def backwards(self, orm):
        
        # Renaming field 'Repository.parent_repo'
        db.rename_column('hgwebproxy_repository', 'parent_repo_id', 'ascendent_id')
