...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('hgwebproxy_repository', ['slug'])

        # Adding unique constraint on 'Repository', fields ['owner', 'slug']
        db.create_unique('hgwebproxy_repository', ['owner_id', 'slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Repository', fields ['owner', 'slug']
        db.delete_unique('hgwebproxy_repository', ['owner_id', 'slug'])

        # Adding unique constraint on 'Repository', fields ['slug']
        db.create_unique('hgwebproxy_repository', ['slug'])
    ...
    models = {
        ...
        'hgwebproxy.repository': {
            'Meta': {'ordering': "['name']", 'unique_together': "(('slug', 'owner'),)", 'object_name': 'Repository'},
            ...
            'parent_repo': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'descendents'", 'null': 'True', 'to': "orm['hgwebproxy.Repository']"}),
