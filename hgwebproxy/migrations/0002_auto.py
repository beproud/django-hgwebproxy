...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field admins on 'Repository'
        db.create_table('hgwebproxy_repository_admins', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('repository', models.ForeignKey(orm['hgwebproxy.repository'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('hgwebproxy_repository_admins', ['repository_id', 'user_id'])

        # Adding M2M table for field admin_groups on 'Repository'
        db.create_table('hgwebproxy_repository_admin_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('repository', models.ForeignKey(orm['hgwebproxy.repository'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('hgwebproxy_repository_admin_groups', ['repository_id', 'group_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field admins on 'Repository'
        db.delete_table('hgwebproxy_repository_admins')

        # Removing M2M table for field admin_groups on 'Repository'
        db.delete_table('hgwebproxy_repository_admin_groups')
